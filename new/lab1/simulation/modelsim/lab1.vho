...
ARCHITECTURE structure OF lab1_board2 IS
...
-- Equation(s):
-- \dut|Mux0~0_combout\ = ( \SW[0]~input_o\ & ( \SW[1]~input_o\ & ( (\SW[3]~input_o\) # (\SW[2]~input_o\) ) ) ) # ( !\SW[0]~input_o\ & ( \SW[1]~input_o\ & ( (\SW[3]~input_o\) # (\SW[2]~input_o\) ) ) ) # ( \SW[0]~input_o\ & ( !\SW[1]~input_o\ & ( 

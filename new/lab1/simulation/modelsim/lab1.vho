...
-- LEDR8	=>  Location: PIN_AK28,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- SW8	=>  Location: PIN_AD25,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
-- Equation(s):
-- \dut|segment_out|Mux6~0_combout\ = ( !\SW[3]~input_o\ & ( !\SW8~input_o\ & ( (!\SW[2]~input_o\ & (!\SW[1]~input_o\ & \SW[0]~input_o\)) ) ) )
...
-- Equation(s):
-- \dut|segment_out|Mux5~0_combout\ = ( \SW[3]~input_o\ & ( \SW8~input_o\ ) ) # ( !\SW[3]~input_o\ & ( \SW8~input_o\ & ( (!\SW[0]~input_o\ & ((!\SW[1]~input_o\) # (\SW[2]~input_o\))) # (\SW[0]~input_o\ & ((\SW[1]~input_o\))) ) ) ) # ( \SW[3]~input_o\ & ( 
-- !\SW8~input_o\ & ( ((\SW[1]~input_o\) # (\SW[2]~input_o\)) # (\SW[0]~input_o\) ) ) ) # ( !\SW[3]~input_o\ & ( !\SW8~input_o\ & ( \SW[2]~input_o\ ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000111100001111001111111111111111001100001111111111111111111111",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
...
-- Equation(s):
-- \dut|segment_out|Mux4~0_combout\ = ( \SW[3]~input_o\ & ( \SW8~input_o\ ) ) # ( !\SW[3]~input_o\ & ( \SW8~input_o\ & ( (!\SW[2]~input_o\ & (!\SW[1]~input_o\)) # (\SW[2]~input_o\ & ((!\SW[0]~input_o\) # (\SW[1]~input_o\))) ) ) ) # ( \SW[3]~input_o\ & ( 
-- !\SW8~input_o\ & ( ((\SW[0]~input_o\) # (\SW[1]~input_o\)) # (\SW[2]~input_o\) ) ) ) # ( !\SW[3]~input_o\ & ( !\SW8~input_o\ & ( (!\SW[2]~input_o\ & (\SW[1]~input_o\ & !\SW[0]~input_o\)) # (\SW[2]~input_o\ & ((!\SW[0]~input_o\) # (\SW[1]~input_o\))) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0111000101110001011111110111111111011001110110011111111111111111",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \ALT_INV_SW[2]~input_o\,
...
-- Equation(s):
-- \dut|segment_out|Mux2~0_combout\ = ( !\SW[3]~input_o\ & ( \SW8~input_o\ & ( (!\SW[2]~input_o\ & \SW[1]~input_o\) ) ) ) # ( !\SW[3]~input_o\ & ( !\SW8~input_o\ & ( (\SW[0]~input_o\ & ((!\SW[2]~input_o\) # (!\SW[1]~input_o\))) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0011001100110000000000000000000000000000111100000000000000000000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	datab => \ALT_INV_SW[0]~input_o\,
...
-- Equation(s):
-- \dut|segment_out|Mux1~0_combout\ = ( !\SW[3]~input_o\ & ( \SW8~input_o\ & ( (!\SW[2]~input_o\ & (!\SW[1]~input_o\ $ (!\SW[0]~input_o\))) ) ) ) # ( !\SW[3]~input_o\ & ( !\SW8~input_o\ & ( (!\SW[2]~input_o\ & ((\SW[0]~input_o\) # (\SW[1]~input_o\))) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0010101000101010000000000000000000101000001010000000000000000000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \ALT_INV_SW[2]~input_o\,
...
-- Equation(s):
-- \dut|segment_out|Mux0~0_combout\ = ( !\SW[3]~input_o\ & ( !\SW8~input_o\ & ( (!\SW[1]~input_o\ & !\SW[2]~input_o\) ) ) )
...
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000110000001100001111000011110000001111000011111111111111111111",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	datab => \ALT_INV_SW[0]~input_o\,

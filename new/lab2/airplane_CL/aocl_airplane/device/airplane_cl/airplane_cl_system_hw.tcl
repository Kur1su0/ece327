...
set_module_property NAME airplane_cl_system
set_module_property VERSION 14.0
set_module_property INTERNAL false
set_module_property GROUP Accelerators
set_module_property DISPLAY_NAME airplane_cl_system
...
### SLAVE interface avs_airplane_kernel_cra
add_interface avs_airplane_kernel_cra avalon end
set_interface_property avs_airplane_kernel_cra addressAlignment DYNAMIC
set_interface_property avs_airplane_kernel_cra burstOnBurstBoundariesOnly false
set_interface_property avs_airplane_kernel_cra explicitAddressSpan 0
set_interface_property avs_airplane_kernel_cra holdTime 0
set_interface_property avs_airplane_kernel_cra isMemoryDevice false
set_interface_property avs_airplane_kernel_cra isNonVolatileStorage false
set_interface_property avs_airplane_kernel_cra linewrapBursts false
set_interface_property avs_airplane_kernel_cra maximumPendingReadTransactions 1
set_interface_property avs_airplane_kernel_cra printableDevice false
set_interface_property avs_airplane_kernel_cra readLatency 0
set_interface_property avs_airplane_kernel_cra readWaitTime 0
set_interface_property avs_airplane_kernel_cra setupTime 0
set_interface_property avs_airplane_kernel_cra timingUnits Cycles
set_interface_property avs_airplane_kernel_cra writeWaitTime 0
set_interface_property avs_airplane_kernel_cra ASSOCIATED_CLOCK clock_reset
set_interface_property avs_airplane_kernel_cra ENABLED true
add_interface_port avs_airplane_kernel_cra avs_airplane_kernel_cra_read read Input 1
add_interface_port avs_airplane_kernel_cra avs_airplane_kernel_cra_write write Input 1
add_interface_port avs_airplane_kernel_cra avs_airplane_kernel_cra_address address Input 4
add_interface_port avs_airplane_kernel_cra avs_airplane_kernel_cra_writedata writedata Input 64
add_interface_port avs_airplane_kernel_cra avs_airplane_kernel_cra_byteenable byteenable Input 8
add_interface_port avs_airplane_kernel_cra avs_airplane_kernel_cra_readdata readdata Output 64
add_interface_port avs_airplane_kernel_cra avs_airplane_kernel_cra_readdata readdata Output 64
add_interface_port avs_airplane_kernel_cra avs_airplane_kernel_cra_readdatavalid readdatavalid Output 1
...
set_fileset_property QUARTUS_SYNTH TOP_LEVEL airplane_cl_system
set_fileset_property QUARTUS_SYNTH ENABLE_RELATIVE_INCLUDE_PATHS false
add_fileset_file airplane_cl.v SYSTEM_VERILOG PATH airplane_cl.v TOP_LEVEL_FILE
add_fileset_file airplane_cl_system.v SYSTEM_VERILOG PATH airplane_cl_system.v TOP_LEVEL_FILE
...
add_fileset_file FSM.vhd VHDL PATH ./libraries/no_vendor/no_lib_name/no_version/airplane_cl/FSM.vhd TOP_LEVEL_FILE
add_fileset_file airplane_cl.vhd VHDL PATH ./libraries/no_vendor/no_lib_name/no_version/airplane_cl/airplane_cl.vhd TOP_LEVEL_FILE
...
set_fileset_property SIM_VERILOG TOP_LEVEL airplane_cl_system
add_fileset_file airplane_cl.v SYSTEM_VERILOG PATH airplane_cl.v TOP_LEVEL_FILE
add_fileset_file airplane_cl_system.v SYSTEM_VERILOG PATH airplane_cl_system.v TOP_LEVEL_FILE
add_fileset_file lsu_top.v SYSTEM_VERILOG PATH $::env(ALTERAOCLSDKROOT)/ip/lsu_top.v TOP_LEVEL_FILE
add_fileset_file acl_staging_reg.v SYSTEM_VERILOG PATH $::env(ALTERAOCLSDKROOT)/ip/acl_staging_reg.v TOP_LEVEL_FILE

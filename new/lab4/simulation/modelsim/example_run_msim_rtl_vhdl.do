...
vcom -93 -work work {C:/Users/W/Documents/ece327/new/lab4/board_lab4.vhd}
...
vcom -93 -work work {C:/Users/W/Documents/ece327/new/lab4/simulation/modelsim/regD.vht}

vsim -t 1ps -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L cyclonev -L rtl_work -L work -voptargs="+acc"  regD_vhd_tst

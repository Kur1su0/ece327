...
### SLAVE interface avs_kernel_add_cra
add_interface avs_kernel_add_cra avalon end
set_interface_property avs_kernel_add_cra addressAlignment DYNAMIC
set_interface_property avs_kernel_add_cra burstOnBurstBoundariesOnly false
set_interface_property avs_kernel_add_cra explicitAddressSpan 0
set_interface_property avs_kernel_add_cra holdTime 0
set_interface_property avs_kernel_add_cra isMemoryDevice false
set_interface_property avs_kernel_add_cra isNonVolatileStorage false
set_interface_property avs_kernel_add_cra linewrapBursts false
set_interface_property avs_kernel_add_cra maximumPendingReadTransactions 1
set_interface_property avs_kernel_add_cra printableDevice false
set_interface_property avs_kernel_add_cra readLatency 0
set_interface_property avs_kernel_add_cra readWaitTime 0
set_interface_property avs_kernel_add_cra setupTime 0
set_interface_property avs_kernel_add_cra timingUnits Cycles
set_interface_property avs_kernel_add_cra writeWaitTime 0
set_interface_property avs_kernel_add_cra ASSOCIATED_CLOCK clock_reset
set_interface_property avs_kernel_add_cra ENABLED true
add_interface_port avs_kernel_add_cra avs_kernel_add_cra_read read Input 1
add_interface_port avs_kernel_add_cra avs_kernel_add_cra_write write Input 1
add_interface_port avs_kernel_add_cra avs_kernel_add_cra_address address Input 4
add_interface_port avs_kernel_add_cra avs_kernel_add_cra_writedata writedata Input 64
add_interface_port avs_kernel_add_cra avs_kernel_add_cra_byteenable byteenable Input 8
add_interface_port avs_kernel_add_cra avs_kernel_add_cra_readdata readdata Output 64
add_interface_port avs_kernel_add_cra avs_kernel_add_cra_readdata readdata Output 64
add_interface_port avs_kernel_add_cra avs_kernel_add_cra_readdatavalid readdatavalid Output 1

### SLAVE interface avs_kernel_mul_cra
add_interface avs_kernel_mul_cra avalon end
set_interface_property avs_kernel_mul_cra addressAlignment DYNAMIC
set_interface_property avs_kernel_mul_cra burstOnBurstBoundariesOnly false
set_interface_property avs_kernel_mul_cra explicitAddressSpan 0
set_interface_property avs_kernel_mul_cra holdTime 0
set_interface_property avs_kernel_mul_cra isMemoryDevice false
set_interface_property avs_kernel_mul_cra isNonVolatileStorage false
set_interface_property avs_kernel_mul_cra linewrapBursts false
set_interface_property avs_kernel_mul_cra maximumPendingReadTransactions 1
set_interface_property avs_kernel_mul_cra printableDevice false
set_interface_property avs_kernel_mul_cra readLatency 0
set_interface_property avs_kernel_mul_cra readWaitTime 0
set_interface_property avs_kernel_mul_cra setupTime 0
set_interface_property avs_kernel_mul_cra timingUnits Cycles
set_interface_property avs_kernel_mul_cra writeWaitTime 0
set_interface_property avs_kernel_mul_cra ASSOCIATED_CLOCK clock_reset
set_interface_property avs_kernel_mul_cra ENABLED true
add_interface_port avs_kernel_mul_cra avs_kernel_mul_cra_read read Input 1
add_interface_port avs_kernel_mul_cra avs_kernel_mul_cra_write write Input 1
add_interface_port avs_kernel_mul_cra avs_kernel_mul_cra_address address Input 4
add_interface_port avs_kernel_mul_cra avs_kernel_mul_cra_writedata writedata Input 64
add_interface_port avs_kernel_mul_cra avs_kernel_mul_cra_byteenable byteenable Input 8
add_interface_port avs_kernel_mul_cra avs_kernel_mul_cra_readdata readdata Output 64
add_interface_port avs_kernel_mul_cra avs_kernel_mul_cra_readdata readdata Output 64
add_interface_port avs_kernel_mul_cra avs_kernel_mul_cra_readdatavalid readdatavalid Output 1
...
add_fileset_file mat_cl.v SYSTEM_VERILOG PATH mat_cl.v TOP_LEVEL_FILE
add_fileset_file mat_cl_system.v SYSTEM_VERILOG PATH mat_cl_system.v TOP_LEVEL_FILE
